            ...
            Row(
              ...
              children: [
                ...
                _buildMetricBox('Desperdício',
                    wasteProduction.toStringAsFixed(2) + ' g', Colors.purple),
              ],
            ),
            SizedBox(height: 16),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                _buildMetricBox('Uso de água',
                    waterUsage.toStringAsFixed(2) + ' l', Colors.indigo),
                SizedBox(width: 16),
                _buildMetricBox('Produção de comida',
                    foodProduction.toStringAsFixed(2) + ' g', Colors.pink),
                SizedBox(width: 16),
                _buildMetricBox('Uso de papel',
                    paperUsage.toStringAsFixed(2) + ' g', Colors.blue),
              ],
            ),
            SizedBox(height: 16),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                _buildMetricBox('Uso de plástico',
                    plasticUsage.toStringAsFixed(2) + ' g', Colors.purple),
                SizedBox(width: 16),
                // _buildMetricBox('Air Travel', airTravel.toStringAsFixed(2) + ' mi', Colors.indigo),
                _buildMetricBox('Consumo de água',
                    meatConsumption.toStringAsFixed(2) + ' g', Colors.pink),
              ],
            ),
            SizedBox(height: 16),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                _buildMetricBox('Produção de roupa',
                    clothingProduction.toStringAsFixed(2) + ' g', Colors.blue),
              ],
            ),
          ],
        ),
